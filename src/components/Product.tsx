...
function ProductDetailPage({
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'specs' | 'tech' | 'install' | 'reviews'
  >('overview');
    ...
    <div className="animate-fade-in text-gray-900 pt-20 md:pt-24">
      {lightboxOpen && (
        <Lightbox
          ...
          onPrev={() =>
            setLightboxIdx(i => (i - 1 + product.gallery.length) % product.gallery.length)
          }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            >
              ...
              {product.badge && (
                <span
                  className={`absolute top-4 left-4 ${getBadgeStyle(product.badge)} text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-lg shadow-lg`}
                >
                  {product.badge}
                </span>
              )}
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-green-400 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    {product.installationType.split('—')[0]}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-green-400 transition-colors">
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="button"
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors"
              >
              ...
              <button
                type="button"
                className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-300 text-gray-700 font-bold rounded-xl hover:border-green-600 hover:text-green-600 transition-colors"
              >
                ...
                {product.features.map((f, i) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <span className="text-green-600 text-lg opacity-0 group-hover:opacity-100 transition-opacity">
                        →
                      </span>
                    </div>
                    <div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {product.faqs.map((faq, i) => (
                  <div
                    key={i}
                    className="border-2 border-gray-200 rounded-xl overflow-hidden hover:border-green-400 transition-colors"
                  >
                    <button
                      type="button"
            ...
            <div className="space-y-0 bg-white rounded-xl border-2 border-gray-200 overflow-hidden">
              {product.specs.map((spec, i) => (
                ...
                >
                  ...
                  {expandedSpec === i && (
                    <div className="px-6 pb-4 text-sm text-gray-700 bg-green-50">{spec.value}</div>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="animate-fade-in py-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {product.features.slice(0, 6).map((f, i) => (
                  <div
                    key={i}
                    className="bg-gradient-to-br from-green-50 to-indigo-50 p-5 rounded-lg border-2 border-green-200 space-y-2 hover:shadow-md transition-shadow"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                {product.compatibility.map((c, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-2 bg-white border-2 border-green-200 px-4 py-3 rounded-lg hover:border-green-600 hover:bg-green-50 transition-all"
                  >
            ...
            <div className="bg-indigo-50 border-2 border-indigo-200 p-6 rounded-xl space-y-3">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                This product uses advanced wireless mesh networking technology to communicate with
                other devices in your home. Data is encrypted using military-grade AES encryption,
                and all operations can run locally without internet connection. Automatic updates
                keep the device secure and add new features over time.
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'install' && (
          <div className="animate-fade-in py-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={item.step}
                    className="flex gap-4 p-4 bg-white border-2 border-gray-200 rounded-lg hover:border-green-400 transition-colors"
                  >
                ...
                {[
                  ...
                  return resource.href ? (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-bold text-sm text-gray-900 group-hover:text-green-600 transition-colors">
                          {resource.title}
                        </p>
            ...
            <div className="bg-yellow-50 border-2 border-yellow-300 p-6 rounded-xl">
              <p className="text-xs font-bold text-yellow-900 uppercase tracking-wider">
          ...
          <div className="animate-fade-in py-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              {product.testimonials.map((t, i) => (
                <div
                  key={i}
                  className="p-6 bg-white rounded-xl border-2 border-gray-200 hover:border-green-400 hover:shadow-md transition-all space-y-4"
                >
            ...
            {relatedProducts.map(rp => (
              ...
              >
                <div className="aspect-[4/3] overflow-hidden relative bg-gray-100">
                  ...
                  {rp.badge && (
                    <span
                      className={`absolute top-3 left-3 ${getBadgeStyle(rp.badge)} text-[9px] font-bold uppercase px-2.5 py-1 rounded-lg`}
                    >
                      {rp.badge}
                    </span>
                  )}
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-8 sm:p-12 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="space-y-2 flex-1">
            ...
            <p className="text-green-100 text-sm">
              Our expert support team is available 24/7 to help you with information, compatibility,
    ...
    <div className="animate-fade-in text-gray-900">
      ...
      <section className="px-4 sm:px-6 md:px-12 max-w-7xl mx-auto pb-8">
        ...
        <div className="hidden md:flex flex-wrap justify-center gap-2 mb-4">
          ...
          >
            All Products
            <span className={`px-2 py-0.5 text-xs rounded-full ${categoryFilter === 'all' ? 'bg-white/20' : 'bg-gray-200'}`}>
              {productsData.length}
            </span>
          </button>
          {productCategories.map(cat => {
            ...
            return (
              ...
              >
                {cat.label}
                <span className={`px-2 py-0.5 text-xs rounded-full ${categoryFilter === cat.id ? 'bg-white/20' : 'bg-gray-200'}`}>
                  {count}
                </span>
              </button>
            );
        ...
        <div className="md:hidden flex items-center justify-between gap-3 mb-4">
          ...
          {categoryFilter !== 'all' && (
            <button
              type="button"
              onClick={() => setCategoryFilter('all')}
              className="shrink-0 px-4 py-3 text-sm font-semibold text-green-600 border-2 border-green-600 rounded-xl hover:bg-green-50 transition-colors"
            >
              Clear
            </button>
          )}
            ...
            return (
              ...
              >
                <div className="aspect-[4/3] overflow-hidden relative bg-gray-100">
                  ...
                  {product.badge && (
                    <span
                      className={`absolute top-3 left-3 ${getBadgeStyle(product.badge)} text-[9px] font-bold uppercase px-2.5 py-1 rounded-lg shadow-md`}
                    >
                      {product.badge}
                    </span>
                  )}
